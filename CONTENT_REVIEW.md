...
**Owner-authorized assistant review: 844 game rules approved for the catalog; 356 eligible for the random mix. Public house prompts: 60.**

Twenty-six more identities from the remaining discovery inventory have visually checked publisher-authored manuals and exact approved catalog revisions. Mode and edition limits, publisher-hosted versus preserved manual sources, official fallbacks, and blocked leads are recorded in `research/coverage/remaining-sep25-progress.md`. These twenty-six entries are catalog-only.
