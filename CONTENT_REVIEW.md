...
Spectacular415147, The Great Library432834 and Yami452684 have primary-reviewed distinct identities and remain pending manual review. Root read six complete publisher collection/product texts, all three saved entities and exact numeric hrefs; complete previous holds and source custody remain preserved. Yami's product-title conflict with Kakapo410097 does not approve an alias or merge. The directory now has4,995 identities,885 sourced and4,110 pending, with71 validated native search names. All891 rule records and42 identity overrides remain unchanged. See `research/coverage/sep26-three-native-focus-progress.md`.
