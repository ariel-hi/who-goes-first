...
- [ ] Set a maintained `CONTACT_EMAIL`. Update Privacy with the actual host and logging/retention behavior; review the current local-storage behavior. Keep tracking and ads disabled unless separately authorized.
