...
Run `npm run content:coverage` or open `/dev/coverage/` to compare the complete inventory with researched editions. At this checkpoint there are 859 researched rule records in total; 818 of 1,333 inventory identities match a researched edition and 515 still need primary-source research. Matching a title does not prove every edition agrees. The owner has delegated editorial review to Codex. All 859 researched exact revisions are approved for the catalog; 359 portable criteria are eligible for the random mix. Research coverage, approval and deployment remain separate.
...
The 2026-09-25 remaining-inventory pass adds 41 publisher-manual editions, including the mode-specific Fish 'n' Flip, Nibble Munch Crunch, Tipperary and Cookie Addict answers, the German Magic Labyrinth and Rondo and French Eternitium summaries, and explicit official alternatives. Blocked downloads and lookalike editions remain pending. See `remaining-sep25-progress.md`.
