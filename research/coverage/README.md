...
Fudacoma, Blue Orange and Artipia add three new research drafts. The Artipia record uses a retailer-hosted copy of an Artipia-branded booklet because the current publisher-linked file was unavailable; it remains held for provenance and variant review. See `fudacoma-blue-orange-artipia-progress.md`.
