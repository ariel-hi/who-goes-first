...
- Each cached intake includes a source hash, exact URL and page count. Relevant pages were rendered and opened under the ignored `research/source-files/queen-schmidt-rendered/` directory before creating the drafts. Codex completed owner-authorized editorial review of all six Queen and five Schmidt records on 2026-09-23; exact approved revisions are under `src/content/games/`.
