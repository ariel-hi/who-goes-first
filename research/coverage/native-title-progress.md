...
Retrieved and reviewed on 2026-09-26 UTC. The supplementary corpus and identity review remain separate from the original English snapshot and its existing review. The initial checkpoint enrolled18 primary-supported accepts. Subsequent reviews now enroll **43 accepts /245 holds /55 reviewed /233 unreviewed**, bringing the effective directory to **4,999 identities**. Every native identity decision still has false starting-rule and edition-transfer approval flags; approved rules use their separate exact-revision workflow.

The [latest Amigo and Quick-result checkpoint](sep26-amigo-and-quick-progress.md) accepts Lama Dice325853, Cabanga!394889 and Meister Makatsu447384 as three distinct identities only. Exact own P123 and full publisher/P856/product context support semantic identity; numeric IDs remain Wikidata-only. Three cached sources and complete prior holds are preserved, with no rule approval or metadata repair. Maître Makatsu adds one existing same-entity French search title. Validated native search terms total73 across26 accepted identities. Coverage remains887 sourced/4,112 pending among4,999 identities; nine other Amigo leads remain unreviewed.

The [preceding Brass and count checkpoint](sep26-brass-and-remembered-count-progress.md) accepts Brass Pittsburgh452264 as an identity only, retaining Wikidata-only numeric authority and explicit primary Pittsburg/saved Pittsburgh spelling, year/player/edition limits. Full En Route418683 review retains its primary406454 and 2024/2025 conflict as a reviewed hold. Both complete original holds and null dispositions remain preserved; four cached sources are registered. Its coverage/search totals remain historical.

The [preceding picker/source checkpoint](sep26-picker-result-continuity-progress.md) left native decisions unchanged and prepared the separate Brass semantic proposal. Its unenrolled and partial En Route root-review status records that historical checkpoint.
