...
Retrieved and reviewed on 2026-09-26 UTC. The supplementary corpus and identity review remain separate from the original English snapshot and its existing review. The initial checkpoint enrolled18 primary-supported accepts. Subsequent reviews now enroll **40 accepts /248 holds /52 reviewed /236 unreviewed**, bringing the effective directory to **4,996 identities**. Every native identity decision still has false starting-rule and edition-transfer approval flags; approved rules use their separate exact-revision workflow.

The [latest Brass and count checkpoint](sep26-brass-and-remembered-count-progress.md) accepts Brass Pittsburgh452264 as an identity only, retaining Wikidata-only numeric authority and explicit primary Pittsburg/saved Pittsburgh spelling, year/player/edition limits. Full En Route418683 review retains its primary406454 and 2024/2025 conflict as a reviewed hold. Both complete original holds and null dispositions remain preserved; four cached sources are registered. Validated native search terms total72 across25 accepted identities. Rule coverage remains887 sourced/4,109 pending among4,996 identities.
